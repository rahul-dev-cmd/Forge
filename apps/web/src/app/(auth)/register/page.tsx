      ...
      <div className="max-w-md w-full border border-border bg-surface rounded-lg p-8 shadow-xs flex flex-col gap-6">
        <div className="flex flex-col gap-2 text-center">
          ...
          <p className="text-xs text-muted-foreground">
            Get started with Forge for repository-aware developer assistance
          </p>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          >
            Register with Email (Demo Only)
          </button>
        </div>

        <div className="relative flex py-2 items-center">
          <div className="flex-grow border-t border-border"></div>
          <span className="flex-shrink mx-4 text-muted-foreground text-[10px] uppercase font-bold tracking-wider">or register with</span>
          <div className="flex-grow border-t border-border"></div>
        </div>
